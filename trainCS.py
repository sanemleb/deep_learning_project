...
import cv2
from CS_test_modules.CSModel import UNET_drone as UNET_d
from CS_test_modules.CSDataset import DroneDataset
from CS_test_modules.CSSettings import IMAGE_PATH, NUM_EPOCHS, MASK_PATH, LEARNING_RATE, device
...
def train():
    model = UNET_d(in_channels=3, out_channels=9)
    model.to(device)
